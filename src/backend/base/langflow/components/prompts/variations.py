...
class MetaComponent(ToolCallingAgentComponent):
    display_name: str = "Variation Generator"
    ...
    async def message_response(self) -> Message:
        ...
        system_prompt = (
        "You are a helpful assistant that uses the input provided to make 3 to 5 variations of the meta prompt based on"
        "different situational conditions."
        "of the variation in a JSON FORMAT "
        "avoid ANY extra text apart from the generated variations."
        )
