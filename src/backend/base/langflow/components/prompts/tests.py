...
class MetaComponent(ToolCallingAgentComponent):
    display_name: str = "Test Generation"
    ...
    async def message_response(self) -> Message:
        ...
        system_prompt = (
            "You are a helpful assistant that generates user input prompts as test cases."
            "based on the context of the meta prompt variations. "
            "give one liner test input prompts, give the output in a JSON format. "
        )
