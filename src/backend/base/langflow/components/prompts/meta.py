...
class MetaComponent(ToolCallingAgentComponent):
    display_name: str = "Meta Prompt generator"
    ...
    async def message_response(self) -> Message:
        ...
        system_prompt = (
            "You are a helpful assistant who uses the input and makes a very detailed meta prompt for it. "
            "The input provided to you would be something like 'empathetic chatbot' or 'I want to make a technical write."
            "Whatever the input, you will take it and generate a very elaborate and large meta system prompt for it."
        )
