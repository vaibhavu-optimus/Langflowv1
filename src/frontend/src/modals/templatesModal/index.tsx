...
export default function TemplatesModal({
  ...
  const categories: Category[] = [
    ...
    },
    {
      title: "Use Cases",
      items: [
        { title: "Agentic Workflows", icon: "BotMessageSquare", id: "assistants" },
        { title: "Data Transformation", icon: "Tags", id: "classification" },
        { title: "Content Generation", icon: "Newspaper", id: "content-generation",},
        { title: "Chatbots", icon: "TerminalIcon", id: "coding" },
        { title: "Data Extraction", icon: "Database", id: "q-a" },
