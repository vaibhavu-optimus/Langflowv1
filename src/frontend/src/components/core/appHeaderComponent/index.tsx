...
import LLMControlLogo from "@/assets/LLMControlLogo.svg?react";
  ...
  return (
    <div className="flex h-[62px] w-full items-center justify-between gap-2 border-b px-5 py-2.5 dark:bg-background">
      ...
      >
        ...
        >
          <LLMControlLogo className="h-10 w-10"/>
        </Button>
        {ENABLE_DATASTAX_LANGFLOW && (
          <>
            <CustomOrgSelector />
      ...
      >
        {!ENABLE_DATASTAX_LANGFLOW && (
          <>
            <Button
              unstyled
              className="hidden items-center whitespace-nowrap pr-5 2xl:inline"
              onClick={() =>
